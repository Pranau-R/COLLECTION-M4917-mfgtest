...
function _setProject {
    #---- project settings -----
    readonly OPTOUTPUTNAME_DEFAULT=Model4917-mfgtest
    readonly OPTARDUINO_SOURCE_DEFAULT=sketches/model4917-mfgtest/model4917-mfgtest.ino
    readonly OPTARDUINO_BOARD_DEFAULT=4917
